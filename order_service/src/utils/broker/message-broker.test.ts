...
import {OrderEvent} from '../../types'; // Adjust if necessary
import {MessageBroker} from './message-broker'; // Your actual broker
import {MessageBrokerType} from './broker.type'; // The interface or types for your broker
    ...
    describe('publish', () => {
        it('should publish a message with a valid OrderEvent', async () => {
            const data = {
                ...
                event: 'ORDER_CREATED' as OrderEvent,
                message: {foo: 'bar'},
            };
